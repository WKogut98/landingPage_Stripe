<script>
    ...
    let currentExpandedQuestion = $state(-1);
    function onclick(index)
    {
        if(currentExpandedQuestion == index)
        {
            currentExpandedQuestion = -1;
            return;
        }
        currentExpandedQuestion = index;
    }
</script>
...
<section class="landing-page-section">
    ...
    <div class = "faq-container">
        {#each faqs as faq, index}
            <FAQItem {faq} isExpanded={index === currentExpandedQuestion}
    ...
    <div class="additional-info">
        ...
        <a href="https://twitter.com/InigoMontoyaRep">
            <p>Hit me up on Twitter<img src={twitterIcon} 
                class="twitter-icon" alt="" /></p>
        </a>
    </div>
</section>
